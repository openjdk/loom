...
LatestMethodCache* Universe::_object_monitorEnterC2_cache = nullptr;
...
LatestMethodCache* Universe::_object_monitorExitC2_cache = nullptr;
...
void Universe::initialize_known_methods(TRAPS) {
  ...
  // setup Object monitor methods
  initialize_known_method(_object_monitorEnterC2_cache,
                          vmClasses::Object_klass(),
                          "monitorEnterC2",
                          vmSymbols::object_void_signature(), true, CHECK);
  _object_monitorEnterC2 = object_monitorEnterC2_method();
  ...
  initialize_known_method(_object_monitorExitC2_cache,
                          vmClasses::Object_klass(),
                          "monitorExitC2",
                          vmSymbols::object_void_signature(), true, CHECK);
  _object_monitorExitC2 = object_monitorExitC2_method();
