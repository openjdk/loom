...
class JvmtiExport : public AllStatic {
 ...
 public:
  ...
  static void post_monitor_contended_enter(JavaThread *thread, oop obj) NOT_JVMTI_RETURN;
  static void post_monitor_contended_entered(JavaThread *thread, ObjectMonitor *obj_mntr) NOT_JVMTI_RETURN;
  static void post_monitor_contended_entered(JavaThread *thread, oop obj) NOT_JVMTI_RETURN;
  ...
  static void post_monitor_waited(JavaThread *thread, oop obj, jboolean timed_out) NOT_JVMTI_RETURN;
