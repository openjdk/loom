...
address OptoRuntime::_complete_monitor_locking_method_Java               = nullptr;
address OptoRuntime::_complete_monitor_locking_block_Java               = nullptr;
address OptoRuntime::_complete_monitor_unlocking_Java               = nullptr;
address OptoRuntime::_complete_monitor_unlocking_method_Java               = nullptr;
address OptoRuntime::_complete_monitor_unlocking_block_Java               = nullptr;
...
bool OptoRuntime::generate(ciEnv* env) {
  ...
  gen(env, _complete_monitor_locking_method_Java  , complete_monitor_enter_Type           , SharedRuntime::complete_monitor_locking_method_C,   0, false, false);
  gen(env, _complete_monitor_locking_block_Java  , complete_monitor_enter_Type           , SharedRuntime::complete_monitor_locking_block_C,   0, false, false);
  ...
  gen(env, _complete_monitor_unlocking_method_Java  , complete_monitor_exit_Type           , SharedRuntime::complete_monitor_unlocking_method_C,   0, false, false);
  gen(env, _complete_monitor_unlocking_block_Java  , complete_monitor_exit_Type           , SharedRuntime::complete_monitor_unlocking_block_C,   0, false, false);
