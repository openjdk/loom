...
public final class ScopedValue<T> {
    ...
    public static final class Carrier {
        ...
        /**
         * Runs a value-returning operation with the scoped values, that are keys in this
         * mapping bound to the values in this mapping.
         *
         * Code invoked by {@code op} can use the {@link #get() get} method to get the
         * value of the scoped value. The scoped values revert to their previously-bound
        ...
        /**
         * Runs an operation with the scoped values, that are keys in this mapping
         * bound to the values in this mapping.
         *
         * Code invoked by {@code op} can use the {@link #get() get} method to get the
         * value of the scoped value. The scoped values revert to their previously-bound
         * values, or become {@linkplain #isBound() unbound}, when the operation completes.
     ...
     * a value. The following example runs an operation with k1 bound (or rebound) to v1,
    ...
    /**
     * Run a value returning operation with a {@code ScopedValue} bound to a value
