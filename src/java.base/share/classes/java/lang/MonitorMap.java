...
/*
 * This is a customized version of java.util.concurrent.ConcurrentHashMap for
 * use with Java object monitors, to provide the mapping from Objects to their
 * Monitors.
 *
 * Customizations:
 * - no use of synchronized allowed
 * - no use of ThreadLocalRandom allowed
 * - Stores WeakReferences to Objects as key
 * - Uses "identity hashcode" functionality as we can't permit synchronized
 *   hashcode() implementations.
 * - doesn't support public Collection interfaces (e.g. ConcurrentMap)
 ...
 */
/* package */ final class MonitorMap<K,V> {
     ...
     */
    public MonitorMap(int initialCapacity) {
     ...
     * @since 1.6
     */
    public MonitorMap(int initialCapacity, float loadFactor) {
    ...
    private final void addCount(long x, int check) {
        ...
        if ((cs = counterCells) != null ||
            ...
            if (cs == null || (m = cs.length - 1) < 0 ||
                ...
                (c = cs[((int)System.nanoTime()) & m]) == null ||
                !(uncontended =
    ...
    private static final long SIZECTL
        = U.objectFieldOffset(MonitorMap.class, "sizeCtl");
    private static final long TRANSFERINDEX
        = U.objectFieldOffset(MonitorMap.class, "transferIndex");
    private static final long BASECOUNT
        = U.objectFieldOffset(MonitorMap.class, "baseCount");
    private static final long CELLSBUSY
        = U.objectFieldOffset(MonitorMap.class, "cellsBusy");
