...
/**
 * Support class for printing information on virtual threads registered for I/O.
 */
public class PollerInfo {
    ...
    /**
     * Print stats on virtual threads registered for I/O to the given string buffer.
     * A no-op if the Poller mechanism has not initialized.
     */
    public static void appendPollerInfo(StringBuilder sb) {
        if (!started)
            return;
